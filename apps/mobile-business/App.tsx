...
export default function App() {
  ...
  useEffect(() => {
    ...
    configureTokenPersistence(businessTokenPersistence);
    hydrateAuthFromPersistence()
      .then((u) => {
  ...
  if (user) {
    return (
      <View style={styles.container}>
        <Text style={styles.title}>Xelnova Business</Text>
  ...
  return (
    ...
    >
      <Text style={styles.title}>Xelnova Business</Text>
      <Text style={styles.sub}>Business buyer accounts only</Text>
      <TextInput
        style={styles.input}
