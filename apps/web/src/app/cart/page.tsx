        ...
        <div className="grid gap-6 lg:grid-cols-3 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="rounded-2xl border border-border bg-white p-5 shadow-card sm:p-6 lg:sticky lg:top-24 xl:top-28">
              ...
              <button type="button" onClick={handleCheckout} className="mt-4 flex min-h-[48px] w-full cursor-pointer items-center justify-center gap-2 rounded-xl bg-primary-600 py-3.5 text-sm font-bold text-white shadow-primary transition-all hover:bg-primary-700">
