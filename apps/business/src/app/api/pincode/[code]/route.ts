...
/**
 * Server-side proxy for India Post pincode lookup. Same purpose as the
 * web app's route — keeps third-party timeouts out of the browser console
 * and lets us cache successful lookups for 24h.
 */
