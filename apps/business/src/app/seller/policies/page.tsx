...
const policies = [
  ...
  { icon: Users, title: '9. Seller Support', content: 'Dedicated seller support is available Mon-Sat, 9 AM - 6 PM IST via email (sellers@xelnova.in) and phone (+91 9259131155). Priority support is available for sellers with over ₹5L monthly GMV through a dedicated account manager.' },
];
