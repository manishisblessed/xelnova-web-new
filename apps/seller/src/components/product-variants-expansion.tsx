...
import { ChevronDown, ChevronUp, Package, Package2 } from 'lucide-react';
 ...
 * with their SKU, price, stock, and images.
 */
            ...
            <table className="w-full text-xs">
              <thead className="bg-surface-muted/50 border-b border-border">
                <tr>
                  ...
                  <th className="px-4 py-2.5 text-right font-semibold text-text-primary">MRP</th>
