  ...
  return (
    <>
      ...
      <div className="px-6 pt-6">
        <div className="rounded-xl border border-border bg-surface-muted/40 px-4 py-3 text-xs text-text-muted leading-relaxed">
          <strong className="text-text-primary">Commission is per-product.</strong>{' '}
          The rate that&apos;s actually charged is set when the admin approves
          each product (Products → Approve). The category rules below are
          reference defaults you can use to decide what to type in at
          approval time — they aren&apos;t auto-applied.
        </div>
      </div>
